...
<table border=0 width=100% cellpadding=0 cellspacing=0>
 <tr> 
  ...
  <tr>
    <td align="center" bgcolor="#eeeeee"><form id="form2" name="form2" method="post" action="bridge.php?module=admin_facturacion_b">
                  Buscar Cliente: 
...
<td bgcolor="'.$bgcolor.'" class="dataclass">'.$row["nombre"].'</td><td bgcolor="'.$bgcolor.'" class="dataclass" align=middle width=200><a href="?module=admin_facturacion_b&idCliente='.$row["idCliente"].'&accela=newfactura">Generar Factura para este Cliente</a></td></tr>';
...
echo'<form method="post" action="process.php?module=facturacion&accela=new" target="_blank"><table width="100%" border="0" cellspacing="3" cellpadding="3">
<input name="idCliente" type="hidden" value="'.$idCliente.'" />
  ...
  <tr>
    <td>&nbsp;</td>
    <td><input type="submit" name="Submit3" value="Crear e imprimir" onClick="location.href=\'pre_facturacion.php\'"/></td>
  </tr>
</table></form>';							
